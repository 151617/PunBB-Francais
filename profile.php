...
'Delete warning'			=>	'<strong>Attention !</stracong> Vous ne pourrez pas restaurer un utilisateur supprimé, ni ses messages.',
'Delete posts info'			=>	'<strong>Attention !</strong> Si vous décidez de ne pas supprimer les messages de cet utilisateur, ils ne pourront être supprimés que manuellement ultérieurement.',
...
// Avatar stuff
'Avatar welcome'			=>	'Définissez une image d’avatar',
'Avatar welcome user'		=>	'Définissez une image d’avatar pour %s',
...
'Bad type'					=>	'Le fichier que vous voulez télécharger n’est pas dans un des formats autorisés (gif, jpeg et png).',
...
'Too wide or high'			=>	'Le fichier que vous voulez télécharger dépasse les dimensions autorisées (%sx%s pixels).',
...
'View user forum subscriptions'	=>	'Voir tous les abonnements de %s',
'Realname'					=>	'Nom réel',
...
'Send forum e-mail'			=>	'Envoyer un courriel depuis le forum',
...
'Signature info'			=>	'Votre signature sera ajoutée à la fin de vos messages.',
...
'Settings welcome'			=>	'Modifier vos paramètres de localisation, affichage et courriel',
'Settings welcome user'		=>	'Modifier les paramètres de localisation, affichage et courriel de %s',
...
'E-mail and sub settings'	=>	'Paramètres de courriel et d’abonnement',
'Subscription settings'		=>	'Paramètres d’abonnement',
'Notify full'				=>	'Inclure la copie du message dans les courriels d’abonnement.',
'Subscribe by default'		=>	'S’abonner automatiquement aux sujets quand vous y participez.',
...
'Pass key bad'				=>	'La clé d’activation du mot de passe est incorrecte ou a expiré. Veuillez redemander un nouveau mot de passe. En cas de nouvel échec, contactez l’administrateur du forum %s.',
...
// Change E-mail stuff
'Change e-mail errors'		=>	'<strong>Attention !</strong> Les erreurs qui suivent doivent être corrigées pour que votre adresse de courriel soit mise à jour :',
'E-mail key bad'			=>	'La clé d’activation de courriel fournie est incorrecte ou a expiré. Veuillez redemander une modification d’adresse de courriel. En cas de nouvel échec, contactez l’administrateur du forum %s.',
...
'Change your e-mail'		=>	'Changer votre adresse de courriel',
'Change user e-mail'		=>	'Changer l’adresse de courriel de %s',
...
'Agree'						=>	'D’accord',
'Registration flood'		=>	'Un nouvel utilisateur s’est inscrit avec votre adresse IP dans l’heure écoulée. Pour éviter un déluge d’inscriptions, une heure doit s’écouler entre deux inscriptions à partir de la même IP. Merci de votre compréhension.',
'Pass too short'			=>	'Les mots de passe ne peuvent faire moins de 4 caractères. Veuillez en choisir un plus long.',
'Pass not match'			=>	'Les mots de passe sont différents.',
'E-mail not match'			=>	'Les adresses de courriel diffèrent.',
'Banned e-mail'				=>	'L’adresse de courriel que vous avez saisie est bannie de ce forum. Veuillez en utiliser une autre.',
'Dupe e-mail'				=>	'Quelqu’un d’autre s’est déjà inscrit avec cette adresse de courriel. Veuillez en utiliser une autre.',
'Reg e-mail'				=>	'Merci de vous être inscrit. Un courriel a été envoyé à l’adresse saisie, indiquant comment activer votre nouveau compte. S’il ne vous parvient pas, contactez l’administrateur %s.',
'Reg complete'				=>	'Inscription terminée. Connexion et redirection…',
'Register errors'			=>	'<strong>Attention !</strong> Les erreurs qui suivent doivent être corrigées avant de vous inscrire :',
'E-mail info'				=>	'<strong>Attention !</strong> Un courrier contenant un lien d’activation va être envoyé à votre nouvelle addresse. Vous devrez cliquer sur ce lien pour activer la nouvelle adresse. Assurez-vous d’avoir saisi une adresse de courriel valide.',
'Reg e-mail info'			=>	'<strong>Attention !</strong> Un courrier contenant un lien d’activation va être envoyé à l’adresse indiquée. Vous devrez cliquer sur ce lien pour activer votre nouveau compte. Ceci doit être fait dans les 72 heures, sinon l’inscription sera effacée.',
...
'E-mail'					=>	'Courriel',
'E-mail help'				=>	'Une adresse de courriel valide.',
'Confirm e-mail'			=>	'Confirmez votre adresse de courriel',
'Confirm e-mail help'		=>	'Resaisissez votre adresse exactement comme la précédente.',
...
'E-mail settings'			=>	'Paramètres de courriel',
'E-mail setting 1'			=>	'Votre adresse de courriel est visible par tous.',
'E-mail setting 2'			=>	'Votre adresse de courriel est cachée mais on peut vous écrire via le forum.',
'E-mail setting 3'			=>	'Votre adresse de courriel est cachée et on ne peut pas vous écrire via le forum.',
...
'Username BBCode'			=>	'Le nom d’utilisateur ne doit pas contenir de balises BBCode. Veuillez corriger.',
'Username IP'				=>	'Le nom d’utilisateur ne doit pas avoir le format d’une adresse IP. Veuillez corriger.',
'Username censor'			=>	'Le nom d’utilisateur que vous avez choisi contient un ou des mots censurés. Veuillez corriger.',
...
'Username guest'			=>	'Le nom d’utilisateur Invité est réservé. Veuillez corriger.',
'Username reserved chars'	=>	'Le nom d’utilisateur ne doit pas contenir les caractères ’, " et [ ou ] en même temps. Veuillez corriger.',
...
'Signature quote/code/list'	=>	'La signature ne peut contenir les balises (BBCode) [quote], [code] ou [list]. Utilisez d’autres tags ou effacez tout.',
